...
/**
 * <p>
 * Implementation of a check that file names and paths must match (or don't
 * match) against specified patterns. It can also be used to verify files match
 * specific naming patterns not covered by other checks (Ex: properties, xml,
 * etc.).
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The match property controls whether the check reports files that match or
 * don't match the supplied regular expressions. If the file name pattern is
 * supplied, the matching is only applied to the file name pattern and not the
 * folder pattern. If no file name pattern is supplied, then matching is applied
 * to the folder pattern only and will result in all files in a folder to be
 ...
 * file name pattern is supplied, otherwise it is applied on the folder pattern.
 * Default value is true.</li>
 *
 * <li>
 * ignoreFileExtensions - Whether to ignore the file extension for the file name
 * match. Default value is false.</li>
 *
 * <li>
 ...
 *     value=&quot;^([A-Z][a-z0-9]+\.?)+$&quot;/&gt;
 *   &lt;property name=&quot;match&quot; value=&quot;false&quot;/&gt;
 *   &lt;property name=&quot;ignoreFileExtensions&quot; value=&quot;true&quot;/&gt;
 * &lt;/module&gt;
 * </pre>
 * <p>
 * To configure the check to only allow property files to be located in the
 * resource folder:
 * </p>
 *
 * <pre>
...
public class RegexpOnFilenameCheck extends AbstractFileSetCheck {
     ...
     *
     * @param ignoreFileExtensions check's option for ignoring file extension.
     */
    public void setIgnoreFileExtensions(boolean ignoreFileExtensions) {
    ...
    private boolean isMatchFolder(String folderPath) {
        ...
        if (folderPattern == null) {
            ...
            // null pattern means 'match' applies to the folder pattern matching
